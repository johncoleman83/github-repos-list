...
#  Clojure and Leiningen custom
#  ----------------------------------------
export CLOJURE_PATH=$HOME/.local/bin:$HOME/bin
export GOPATH=$HOME/go
export PATH=$PATH:$CLOJURE_PATH:$GOPATH/bin
...
#    connect: %{time_connect} pretransfer: %{time_pretransfer} starttransfer: %{time_starttransfer} total: %{time_total}\n" ; }
